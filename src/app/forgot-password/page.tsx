            ...
            <div className="w-full max-w-md min-w-0 mx-auto relative z-10">
                ...
                >
                    ...
                    <AnimatePresence mode="wait">
                        {emailSent && (
                            ...
                            >
                                ...
                                <p className="font-semibold text-base">Reset link sent!</p>
                                <p className="text-emerald-600/70 text-xs">Check your inbox for a password reset link. It may take a minute to arrive.</p>
                            </motion.div>
                        )}
                    </AnimatePresence>
                    ...
                    <div className="text-center pt-6 text-sm text-charcoal/60">
                        <Link href="/login" className="text-moss font-semibold hover:underline inline-flex items-center gap-1">
